...
class XMLCreator {
    ...
    if($this->tag == "message" || $this->tag == "operation"){
      if($this->attributs['name']=='__construct' || $this->attributs['name']=='__constructResponse'){
        return "";
      }
    }

    if($this->tag == "portType" && $this->attributs['name'] != "SoapsControllerPortType"){
      return "";
    }

    if($this->tag == "binding" && $this->attributs['name'] != "SoapsControllerBinding"){
      return "";
    }

    if($this->tag == "port" && $this->attributs['name'] != "SoapsControllerPort"){
      return "";
    }
