...
$(document).ready(function() {
    ...
    */
    ...
    $(document).find('.add-all-to-wishlist , .wishlist-icon, .top-songs .add-to-wishlist, .album-info .add-to-wishlist , .songs .add-to-wishlist , .songs-results-list .add-to-wishlist, .song-container .wishlist-icon').on('click', function(e)
    {
