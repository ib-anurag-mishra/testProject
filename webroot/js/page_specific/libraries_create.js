...
function addVariable(val) {
		...
		var textData =  "<table id='table"+fields+"' cellspacing='6' cellpadding='0' border='0'><tr id='var"+fields+"'><td align='right' width='250' class='libalign'><label>Library Authentication Variable</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][authentication_variable]' class='form_fields' size='50'></td></tr><tr><td align='right' width='250'><label>Library Comparison Operator</label></td><td align='left' style='padding-left:20px' class='libselect'><select name='data[Variable]["+fields+"][comparison_operator]' id='oprDrop"+fields+"' onchange='getResponse("+fields+")'><option value=''>Select a Operator</option><option value='='>=</option><option value='>'>></option><option value='<'><</option><option value='<>'><></option><option value='contains'>Contains</option><option value='date'>Expired</option></select></td></tr><tr id='response"+fields+"'><td align='right' width='250' class='libalign'><label>Library Authentication Response</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][authentication_response]' class='form_fields' size='50' id='responseField"+fields+"'></td></tr><tr><td align='right' width='250'><label>Message No</label></td><td align='left' style='padding-left:20px' class='libselect'><select name='data[Variable]["+fields+"][message_no]' id='msg"+fields+"'><option value=''>Select a Message No</option><option value='24'>24</option><option value='64'>64</option><option value='98'>98</option></select></td></tr><tr id='error"+fields+"'><td align='right' width='250' class='libalign'><label>Library Error Message</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][error_msg]' class='form_fields' size='50'><input type='button' value='Remove' class='form_fields' onClick='removeVariable("+fields+");'></td></tr></table>";
		} 
		else{
		var textData =  "<table id='table"+fields+"' cellspacing='6' cellpadding='0' border='0'><tr id='var"+fields+"'><td align='right' width='250' class='libalign'><label>Library Authentication Variable</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][authentication_variable]' class='form_fields' size='50'></td></tr><tr><td align='right' width='250'><label>Library Comparison Operator</label></td><td align='left' style='padding-left:20px' class='libselect'><select name='data[Variable]["+fields+"][comparison_operator]' id='oprDrop"+fields+"' onchange='getResponse("+fields+")'><option value=''>Select a Operator</option><option value='='>=</option><option value='>'>></option><option value='<'><</option><option value='<>'><></option><option value='contains'>Contains</option><option value='date'>Expired</option></select></td></tr><tr id='response"+fields+"'><td align='right' width='250' class='libalign'><label>Library Authentication Response</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][authentication_response]' class='form_fields' size='50' id='responseField"+fields+"'></td></tr><tr id='error"+fields+"'><td align='right' width='250' class='libalign'><label>Library Error Message</label></td><td aligh='left'><input type='text' name='data[Variable]["+fields+"][error_msg]' class='form_fields' size='50'><input type='button' value='Remove' class='form_fields' onClick='removeVariable("+fields+");'></td></tr></table>";
