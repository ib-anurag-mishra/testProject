...
function showLibAuthIndex(v){
	var val = $("#oprDrop"+v).val();
        
        
        
        if (val.indexOf("(Fixed)") == -1){
            $("#authentication_variable_index"+v).show();
            $("#authentication_variable_index_field"+v).val(0);
        }else{            
            $("#authentication_variable_index"+v).hide();
