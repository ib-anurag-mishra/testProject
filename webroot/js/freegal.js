        ...
        success: function(response) {
            ...
            else if (msg === 'suces')
            {
                ...
                if(type == 1){
                    document.getElementById('downloads_used').innerHTML = downloadUsedArr[1];
                    if (languageSet === 'en') {
                        document.getElementById('wishlist_song_' + prodId).innerHTML = '<a title="You have already downloaded this Song. Get it from your recent downloads" href="/homes/my_history"><button class="download-btn song-downloaded"></a>';
                    } else {
