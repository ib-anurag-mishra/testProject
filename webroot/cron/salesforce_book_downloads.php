...
EOD;
	...
	public function createReport($file_name, $labels, $final) {
		...
		$header = 'customer_id,library_name,cte,contract_start_date,contract_end_date,value_of_contract,tokens_per_week,' . $labels[0] . ',' . $labels[1] . ',' . $labels[2] . ',' . $labels[3] . ',' . $labels[4] . "\n";
