...
$start_index_url = 'http://192.168.100.24:8080/solr/freegalmusic/dataimport?command=full-import&clean=false'; 

set_time_limit(0);

$sleep_time = 60*60 ;
$email_list = 'nayan225@gmail.com, micah@m68interactive.com';
...
if($checkValidXml) {
  ...
  if('busy' == strtolower($arrData['str'][1])){
    ...
    $log_data .= date('Y-m-d h:i:s').' > Indexing Started ( Response: '.$status_index_resp.' )'.PHP_EOL; 
      
    $msg = 'Indexing Started ('.$status_index_resp.')';
