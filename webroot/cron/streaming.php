  ...
  */
  ...
  function __construct(){
     ...
     if( $this->LIVE == '1' ){
          ...
          mysql_select_db($this->PODUCTION_SONY_DB, $this->sonyDBConnectionObj) 
  ...
  function getAllSongsData() {
   ...
   $songQuery ='SELECT Songs.ProdID, Songs.provider_type, Songs.DownloadStatus, Songs.ProductID, Songs.ISRC FROM Songs where Songs.provider_type="sony" and  Songs.ProdID in(447960,447960
,447961
,447961
,449197
,449197
