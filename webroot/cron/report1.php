...
if(($currentDate == $weekFirstDay) || ($currentDate == $monthFirstDate)) {
	$outputFile = "/reports_output_".date('Y_m_d_h_i_s').".txt";
        ...
        $reports_dir = 'C:\xampp\htdocs_old\freegal\trunk\Development_web\app\webroot\sony_reports1';
          ...
          if($countno > 0){
              ...
              //echo $query;
              $dataresult = mysql_query($query) or die('Query failed: ' . mysql_error());
