          ...
          if($perfect == false){
            switch($type){
              case 'song':
                ...
                $query = '((TSongTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TArtistText:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TComposer:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*)) OR (SongTitle:('.$searchkeyword.') OR Title:('.$searchkeyword.') OR ArtistText:('.$searchkeyword.') OR Composer:('.$searchkeyword.')))';
                break;
              case 'genre':
                $query = '(TGenre:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Genre:('.$searchkeyword.'))';
                break;
              case 'album':
...
//---------------------------------------------------------------------------------------------------------------------------------------//
      ...
      if(!empty($country)){
        ...
        switch($type){
          ...
          case 'video':
            ...
            break;
          case 'composer':
            $query = '(TComposer:(*'.strtolower($searchkeyword).'*) OR Composer:'.$searchkeyword.')';
            $field = 'Composer';
            break;
          default:
            $query = '(TSongTitle:(*'.strtolower($searchkeyword).'*) OR SongTitle:'.$searchkeyword.')';
      ...
      if(!empty($country)){
        ...
        switch($type){
          ...
          case 'genre':
            ...
            break;
          case 'album':
            $query = '(TTitle:(*'.strtolower($searchkeyword).'*) OR Title:'.$searchkeyword.' OR TArtistText:(*'.strtolower($searchkeyword).') OR ArtistText:'.$searchkeyword.' OR CComposer:('.strtolower($searchkeyword).') OR Composer:'.$searchkeyword.'*)';
            $field = 'Title';
            break;
          case 'artist':
            $query = '(TArtistText:(*'.strtolower($searchkeyword).'*) OR ArtistText:'.$searchkeyword.')';
          ...
          case 'label':
            ...
            break;
          case 'video':
            $query = '(TVideoTitle:(*'.strtolower($searchkeyword).'*) OR VideoTitle:'.$searchkeyword.')';
            $field = 'VideoTitle';
            break;
          case 'composer':
            $query = '(TComposer:(*'.strtolower($searchkeyword).'*) OR Composer:'.$searchkeyword.')';
    ...
    function groupSearch($keyword, $type='song', $page=1, $limit = 5){
      ...
      if(!empty($country)){
        ...
        switch($type){
          case 'song':
            $query = '(TSongTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR SongTitle:'.$searchkeyword.')';
            $field = 'SongTitle';
            break;
          case 'genre':
            $query = '(TGenre:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Genre:'.$searchkeyword.')';
          ...
          case 'composer':
            ...
            $query = '(TComposer:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Composer:'.$searchkeyword.')';
            $field = 'Composer';
            break;
          default:
            $query = '(TSongTitle:(*'.strtolower(str_replace('!','\!',$keyword)).'*) OR SongTitle:'.$searchkeyword.')';
            $field = 'SongTitle';
            break;
        }
      ...
      if(!empty($country)){
        ...
        switch($type){
          ...
          case 'genre':
            ...
            break;
          case 'album':
            $query = '(TTitle:('.strtolower($searchkeyword).') OR Title:'.$searchkeyword.' OR CArtistText:('.strtolower($searchkeyword).') OR ArtistText:'.$searchkeyword.' OR CComposer:('.strtolower($searchkeyword).') OR Composer:'.$searchkeyword.')';
            $field = 'Title';
            break;
          case 'artist':
            $query = '(TArtistText:('.strtolower($searchkeyword).') OR ArtistText:'.$searchkeyword.')';
    ...
    function getAutoCompleteData($keyword, $type, $limit=10, $allmusic=0){
      ...
      if(!empty($country)){
        ...
        if($type != 'all'){
          switch($type){
            case 'song':
              $query = '(TSongTitle:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TSongTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR SongTitle:('.$searchkeyword.') )';
              $field = 'SongTitle';
              break;
            case 'genre':
              $query = '(TGenre:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TGenre:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Genre:('.$searchkeyword.'))';
              $field = 'Genre';
              break;
            case 'album':
              $query = '(TTitle:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Title:('.$searchkeyword.'))';
              $field = 'Title';
              break;
            case 'artist':
              $query = '(TArtistText:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TArtistText:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR ArtistText:('.$searchkeyword.'))';
              $field = 'ArtistText';
              break;
            case 'label':
              $query = '(TLabel:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TLabel:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Label:('.$searchkeyword.'))';
              $field = 'Label';
              break;
            case 'video':
              $query = '(TVideoTitle:('.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR TVideoTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR VideoTitle:('.$searchkeyword.') OR TArtistText:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR ArtistText:('.$searchkeyword.'))';
              $field = 'VideoTitle';
              break;
            case 'composer':
              //$query = '(CComposer:('.strtolower($searchkeyword).'*) OR TComposer:('.$searchkeyword.'*) OR Composer:('.$searchkeyword.'*))';
              $query = '(TComposer:('.strtolower($keyword).'*) OR TComposer:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR Composer:('.$searchkeyword.'))';
              $field = 'Composer';
              break;
            default:
              $query = '(TSongTitle:('.strtolower($keyword).'*) OR TSongTitle:(*'.strtolower(str_replace(array(' ','!'),array('\ ','\!'),$keyword)).'*) OR SongTitle:('.$searchkeyword.'))';
              $field = 'SongTitle';
              break;
          }
