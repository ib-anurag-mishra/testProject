...
Class StreamingComponent extends Object
{
    ...
    */
    function checkSongExists($prodId, $providerType,$libraryTerritory){
        ...
        echo $song['Song']['FullLength_Duration'];
        echo $libraryTerritory;
    ...
    */
    function checkLibraryStreaming($libId) {
        ...
        $results = $libraryInstance->find('first',array('conditions' => array('test_library_type = "1"','id' => $libId,'library_status'=>'active'),'fields' => 'library_territory'));
