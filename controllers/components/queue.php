...
Class QueueComponent extends Object
{
	...
	function getQueueDetails($queueID, $territory = '')
	{
		...
		$queueDetail = $queueDetailList->find('all', array(
				'fields' => array('QueueDetail.id', 'QueueList.queue_name', 'QueueList.description', 'Songs.SongTitle', 'Songs.ReferenceID', 'Songs.Advisory',
                                    'Songs.FullLength_Duration', 'Songs.ProdID', 'Songs.provider_type', 'Songs.Title as STitle', 'Songs.ArtistText', 'Songs.Artist', 
                                    'Albums.AlbumTitle', 'Albums.ProdID', 'Albums.provider_type', 'Albums.Title as ATitle', 'AProduct.pid as AlbumProdID', 
                                    'SProduct.pid as SongProdID', 'Albums.CdnPath as ACdnPath', 'Albums.Image_SaveAsName as ASourceURL', 'Songs.CdnPath as SCdnPath',
                                    'Songs.FullLength_SaveAsName as SSaveAsName', 'Countries.StreamingStatus', 'Countries.StreamingSalesDate', 'Countries.DownloadStatus',
                                    'Countries.SalesDate'),
	...
	function getNowstreamingSongDetails($prodId, $providerType, $territory = '')
	{
		...
		$nowStreamingSongDetail = $nowStreamingSongDetailList->find('all', array(
				'fields' => array('Song.SongTitle', 'Song.ReferenceID', 'Song.FullLength_Duration', 'Song.ProdID', 'Song.provider_type',
                                    'Song.Advisory', 'Song.Title as STitle', 'Song.ArtistText', 'Song.Artist', 'Albums.AlbumTitle', 'Albums.ProdID', 'Albums.provider_type', 
                                    'Albums.Title as ATitle', 'Product.pid as AlbumProdID', 'Albums.CdnPath as ACdnPath', 'Albums.Image_SaveAsName as ASourceURL',
                                    'Song.CdnPath as SCdnPath', 'Song.FullLength_SaveAsName as SSaveAsName'),
				'joins' => array(
						array(
                                                        'type' => 'INNER',
                                                        'table' => 'Albums',
