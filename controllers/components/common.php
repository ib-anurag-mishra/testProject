...
STR;
    ...
    function getArtistText($territory){
        ...
        try {
            ...
            $songInstance->Behaviors->attach('Containable');
            ...
            $allArtists = $songInstance->paginate();
            for($j = 65;$j < 93;$j++){
            ...
            $songInstance->bindmodel(array('hasOne'=>array(
                    'Genre' => array(
                    'className' => 'Genre',
                    'foreignKey' => 'ProdID'
                    ),
            ...
            $this->log("Artist Pagenation Query: ".$songInstance->lastQuery(), "cache");
