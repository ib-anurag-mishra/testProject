...
class HomesController extends AppController
{
    ...
    var $name = 'Homes';
    var $helpers = array('Html', 'Ajax', 'Javascript', 'Form', 'Library', 'Page', 'Wishlist', 'WishlistVideo', 'Song', 'Language', 'Session', 'Mvideo', 'Download', 'Videodownload', 'Queue', 'Home');
    ...
    function index() {
    	...
    	$featured = Cache::read("featured" . $territory);
    	...
    	$newCacheVarName = "news". $territory . $language;
    	...
    	if( $territory && $language ) {
    		...
    		if ( $news_rs === false ) {
    			...
    			$news_rs = $this->News->find( 'all', array( 'conditions' => array( 'AND' => array( 'language' => $language, 'place LIKE' => "%" . $territory . "%" ) ),
