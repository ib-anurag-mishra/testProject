	...
	parent::beforeFilter();
        ...
        //        }           
         ...
         $pat_id    =   $this->Session->read('patron');
          ...
          {
                $this->Auth->allow('display','aboutus', 'index', 'us_top_10','chooser','forgot_password', 'new_releases', 'language',  'checkPatron', 'approvePatron','my_lib_top_10', 'ajax_view_national_pagination');
          }
