  ...
  //for caching data
    ...
    $multiple_countries = (($siteConfigData[0]['siteconfigs']['svalue']==1)?true:false);
      ...
      if( (count($genreAll) > 0) && ($genreAll !== false) )
      {
        ...
        $xml_data[$territory]['genre_all'] = $genreAll;	
...
STR;
      ...
      //Restore National top 100  
        ...
        $xml_data[$country]['nationaltop100'] = $data;
      ...
      if(empty($featured)) {
        ...
        $xml_data[$territory]['featured_albums'] = $featured;
      }else{
      ...
      $genres = array("Pop", "Rock", "Country", "Alternative", "Classical", "Gospel/Christian", "R&B", "Jazz", "Soundtracks", "Rap", "Blues", "Folk",
        ...
        if(!empty($data)){ 
            ...
            $xml_data[$territory]['top_ten_genre'][$genre] = $data;
...
STR;
      ...
      if( (count($topDownload) < 1) || ($topDownload === false) )
      {
        ...
        $xml_data['librarytop10'][$libId] = $topDownload;
