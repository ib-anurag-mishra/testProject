...
class CacheController extends AppController {
    ...
    var $uses = array('Song', 'Album', 'Library', 'Download', 'LatestDownload', 'Country', 'Video', 'Videodownload','LatestVideodownload','QueueList', 'Token');
...
STR;
                ...
                if (!empty($data)) {
                    ...
                    foreach($data as $key => $value){                            
                            $albumArtwork = $this->Token->regularToken($value['File']['CdnPath']."/".$value['File']['SourceURL']);
...
exit;
            ...
            if (!empty($featuredVideos)) {
                foreach($featuredVideos as $key => $featureVideo){                    
                    $videoArtwork = $this->Token->regularToken("sony_test/".$featureVideo['File']['CdnPath']."/".$featureVideo['File']['SourceURL']);
            ...
            if(!empty($topDownloads)){
                ...
                {                     
                     $videoArtwork = $this->Token->regularToken("sony_test/".$topDownload['File']['CdnPath']."/".$topDownload['File']['SourceURL']);
                     $videoImage = Configure::read('App.Music_Path').$videoArtwork;
...
STR;
                ...
                if (!empty($data)) {
                    ...
                    foreach($data as $key => $value){                        
                        $albumArtwork = $this->Token->regularToken('sony_test/'.$value['Image_Files']['CdnPath']."/".$value['Image_Files']['SourceURL']);
...
STR;
            ...
            if (!empty($coming_soon_rs)) {
                ...
                {                        
                    $cs_img_url = $this->Token->regularToken($value['File']['CdnPath']."/".$value['File']['SourceURL']);
...
STR;
                ...
                if (!empty($data)) {
                    foreach($data as $key => $value){                         
                         $songs_img = $this->Token->regularToken($value['File']['CdnPath']."/".$value['File']['SourceURL']);
...
STR;
                ...
                if (!empty($data)) {
                    foreach($data as $key => $value){                        
                         $album_img = $this->Token->regularToken($value['File']['CdnPath']."/".$value['File']['SourceURL']);
...
STR;
            ...
            if (empty($featured)) {
                ...
                foreach($featured as $k => $v){                    
                    $albumArtwork = $this->Token->regularToken($v['Files']['CdnPath']."/".$v['Files']['SourceURL']);                          
...
STR;
            ...
            if ((count($topDownload) < 1) || ($topDownload === false)) {
                ...
                foreach($topDownload as $key => $value){                    
                    $albumArtwork = $this->Token->regularToken('sony_test/'.$value['File']['CdnPath']."/".$value['File']['SourceURL']);
                    $videoAlbumImage =  Configure::read('App.Music_Path').$albumArtwork;
