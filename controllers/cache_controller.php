...
class CacheController extends AppController {
    ...
    var $uses = array('Song', 'Album', 'Library', 'Download', 'LatestDownload', 'Country', 'Video', 'Genre', 'Videodownload', 'LatestVideodownload', 'QueueList', 'Territory', 'News', 'Language', 'AuthenticationToken');
