<?php
/*
 File Name : download_video_genres.php
 File Description : Models page for the  download_video_genres table.
 Author : m68interactive
*/

class DownloadVideoGenre extends AppModel
{
  var $name = 'DownloadVideoGenre';
