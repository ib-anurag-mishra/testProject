...
class DownloadVideoPatron extends AppModel
{
  ...
  */
  function getDaysDownloadInformation($libraryID, $date, $territory) {
    ...
    $record = $this->find('all, Currentpatrons.id',array('conditions'=>$conditions, 'joins' => array(array('table' => 'currentpatrons','alias' => 'Currentpatrons','type' => 'left', 'conditions'=> array('Currentpatrons.patronid = DownloadVideoPatron.patron_id', 'Currentpatrons.libid = DownloadVideoPatron.library_id'), 'fields' => array('Currentpatrons.id')))));
