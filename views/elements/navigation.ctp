			...
			<div class="header-right-col" style="right: 10px;">
				<div class="row-1 clearfix">
					...
					<div class="forgot-password">
						<?php __('Forgot your password?'); ?> <a href="/homes/forgot_password"><?php __('Click here to reset it.'); ?></a>
					</div>
					<?php }  
					}else if($this->Session->read("patron")){
                                                                if($libraryInfo['Library']['library_authentication_method'] == "user_account"){?>
					<div class="forgot-password">
						<?php __('Need to change your password?'); ?> <a href="/users/my_account"><?php __('Click here to reset it.'); ?></a>
					</div>
					<?php    }
					}
        ...
        <div class="inner-wrapper">
    		<ul class="clearfix">
    			<li class="regular"><?php echo $html->link(__('Home', true), array('controller' => 'homes','action'=>'index'), array("class"=>$newsCss,"id"=>'home07',"onclick"=>"setUpperNavigation('home07')"));?>
                        ...
                        ?>
                            <li class="regular"><?php echo $html->link(__('Concert Videos', true), $Concertlink, array("class"=>$concertCss,"id"=>'concert07',"target" => '_blank', "onclick"=>"setUpperNavigation('concert07'); ga('send', 'event', 'Top Nav', 'Click', 'Concert Videos')"));?>
                            </li>
                        <?php } ?>
				...
				<ul>
					...
					<li>
						...
						<ul class="stream-sidebar-sub-nav">
							<?php foreach($defaultQueues as $key => $value){
								...
								?>
							<li>
                                <a class="leftfqueuesclass" id="<?=$fqueuesid?>" onclick="setUpperNavigation('<?=$fqueuesid?>')" href="/queuelistdetails/queue_details/<?php echo $value['QueueList']['queue_id'];?>/<?php echo $value['QueueList']['queue_type'];?>/<?php echo base64_encode($value['QueueList']['queue_name']);?>"><?php echo $value['QueueList']['queue_name']; ?></a>
                            </li>
							<?php } ?>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="queue-sidebar-sub-nav">
							<li>
                                <a id="leftnowstreaming07" onclick="setUpperNavigation('leftnowstreaming07')" href="/queuelistdetails/now_streaming"><?php __('Now Streaming'); ?></a>
                            </li>
							<li>
                                <a id="leftsavedqueues07" onclick="setUpperNavigation('leftsavedqueues07')" href="/queues/savedQueuesList/<?php echo $this->Session->read("patron"); ?>"><?php __('Create and Store Playlists'); ?></a>
                            </li>
						</ul>
					</li>
