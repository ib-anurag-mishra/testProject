...
?>
    ...
    <div class="wrapper">
		...
		<nav class="site-nav">
                    ...
                    ?>
                    <ul class="clearfix"><?php __('MUSIC VIDEOS'); ?>
			<li class="regular"><?php echo $html->link(__('News', true), array('controller' => 'homes','action'=>'index'), array("class"=>$newsCss));?></li>			
                        <li class="regular"><?php echo $html->link(__('MUSIC VIDEOS'), array('controller' => 'videos', 'action' =>'index'), array("class"=>$videoCss)); ?></li></li>
