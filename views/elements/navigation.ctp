                        ...
                        ?>
                            <div class="movie-announcements">
                                 ...
                                 <?php foreach($movieAnnouncmentValue as $value) { 
                                            $i++;
                                  ?>   
                                <p><strong><a class="announcments-movie-titles" href="http://<?php echo $domain[0].'.'.Configure::read('App.MoviesPath').'/videos/index/'.$value['announcements']['video_id']; ?>" target ="_blank">
