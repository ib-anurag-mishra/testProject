    ...
    <div class="wrapper">
		...
		<nav class="site-nav">
			...
			<li class="regular"><?php echo $html->link(__('Home', true), array('controller' => 'homes','action'=>'index'), array("class"=>$newsCss,"id"=>'home07',"onclick"=>'setUpperNavigation("home07")'));?></li>			
                        <li class="regular"><?php echo $html->link(__('Music Videos', true), array('controller' => 'videos', 'action' =>'index'), array("class"=>$videoCss,"id"=>'musicVideo07',"onclick"=>'setUpperNavigation("home07")')); ?></li>
