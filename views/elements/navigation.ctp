...
?>
    ...
    <div class="wrapper">
		...
		<nav class="site-nav">
                    ...
                    ?>
                    <ul class="clearfix">
			<li class="regular" id='home07' onclick="setUpperNavigation('home07');"><?php echo $html->link(__('Home', true), array('controller' => 'homes','action'=>'index'), array("class"=>$newsCss));?></li>			
                        <li class="regular" id='musicVideo07' onclick="setUpperNavigation('musicVideo07');"><?php echo $html->link(__('Music Videos', true), array('controller' => 'videos', 'action' =>'index'), array("class"=>$videoCss)); ?></li>
                        ...
                        <li class="regular" id='newsRelease07' onclick="setUpperNavigation('newsRelease07');"><?php echo $html->link(__('New Releases', true), array('controller' => 'homes', 'action' =>'new_releases'), array("class"=>$newReleaseCss)); ?></li> 
                        <li class="regular" id='genre07' onclick="setUpperNavigation('genre07');"><?php echo $html->link(__('Genres', true), array('controller' => 'genres', 'action' =>'view'), array("class"=>$genreCss)); ?></li>   
                        <li class="regular" id="faq07" onclick="setUpperNavigation('faq07');"><?php echo $html->link(__('FAQ', true), array('controller' => 'questions', 'action' =>'index'), array("class"=>$faqCss)); ?></li>
                    </ul>
