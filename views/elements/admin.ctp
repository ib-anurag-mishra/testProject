        ...
        <ul>
          ...
          <li><a href="#">Artist Management</a>
           <ul>
              ...
              <li><?php echo $html->link('Manage Featured Artist', array('controller' => 'Artists','action'=>'manageartist'));?></li>
              <li><?php echo $html->link('Create Artist', array('controller' => 'Artists','action'=>'createartist'));?></li>  
              <li><?php echo $html->link('Artist SlideShow', array('controller' => 'Artists','action'=>'manageartists'));?></li>  
            </ul>
           </li>
