<?php
/*
 File Name : ilogin.ctp
 File Description : view page for ilogin
...
//	echo $session->flash();
	...
	echo '<fieldset>';
	echo $form->create('User', array( 'action' => 'ilogin', 'id' => 'login', 'class'=>'login-form'));
		echo '<div class="row">';
...
<ul class="lang">
	...
	foreach($language as $k => $v){
		?>
		<li id="<?php echo $k; ?>" onClick="changeLang(<?php echo $k;?>,'ilogin')"
		<?php
		if($v == $lang){
			echo 'class = "active"';
		}
