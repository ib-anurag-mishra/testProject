<?php
/*
 File Name : idlogin.ctp
 File Description : view page for idlogin
...
//	echo $session->flash();	
	...
	echo '<fieldset>';	
	echo $form->create('User', array( 'action' => 'idlogin', 'id' => 'login', 'class'=>'login-form'));
		echo '<div class="row">';
...
<ul class="lang">
	...
	foreach($language as $k => $v){
		?>
		<li id="<?php echo $k; ?>" onClick="changeLang(<?php echo $k;?>,'idlogin')"
		<?php
		if($v == $lang){
			echo 'class = "active"';
		}
