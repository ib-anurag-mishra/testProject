	...
	<div>
		...
		<div>
			<table cellspacing="10" cellpadding="0" border="0" width="100%">
				<tr>
					<td align="right" valign="top" width="390"><?php echo $this->Form->label(__('First Name'));?></td>
				...
				<tr>
					<td align="right" valign="top" width="390"><?php echo $this->Form->label(__('Last Name'));?></td>
				...
				<tr>
					<td align="right" valign="top" width="390"><?php echo $this->Form->label(__('Email'));?></td>
				...
				<tr>
					<td align="right" valign="top" width="390"><?php echo $this->Form->label(__('Password'));?></td>
