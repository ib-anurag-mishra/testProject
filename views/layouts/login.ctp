	...
	<div id="main">
			...
			<div style="width:321px;height:529px">
				...
				<div class="form-area">
					...
					<?php echo '<h2>Bienvenido a la p&aacute;gina de ingreso de la M&uacute;sica Freegal</h2><p><strong>La M&uacute;sica Freegal le da acceso a cientos de miles de canciones en el catágo de la M&uacute;sica de Sony.</strong></p>';  ?>
				</div>
				</div>
