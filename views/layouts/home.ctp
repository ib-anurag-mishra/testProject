	...
	?>
			<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					{
					?>// alert("HI");
						$(".termsApproval").colorbox({width:"90%", inline:true, open:true, overlayClose:false, opacity:.5, noEscape: true, href:"#termsApproval_div", onOpen:function(){$(document).unbind("keydown.cbox_close");}});
...
?>
          ...
          <?php 
           ...
           ?>  
               ...
               $(".notificationApproval").colorbox({width:"90%", inline:true, open:true, overlayClose:false, opacity:.5, noEscape: true, href:"#notificationApproval_div", onOpen:function(){$(document).unbind("keydown.cbox_close");}});
