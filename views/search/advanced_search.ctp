	...
	<div id="leftColWrapper">
		<form method="get"><h1 ><label for="search_query">Search music on freegal.com</label></h1>
			...
			<ul  class="clearit" id="searchfilter">
				<li  class=" current  first "><a  href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=all"">All Music</a></li>
				<li ><a  href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=album">Albums</a></li>
				<li ><a  href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=artist">Artists</a></li>
				<li ><a  href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=composer">Composers</a></li>
				<li ><a href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=genre">Genres</a></li>
				<li ><a href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=label">Label</a></li>
				<li ><a href="/search/advanced_search?q=<?php echo $_GET['q']?>&type=song">Songs</a></li>
			</ul>
		</form>
	 </div>
</div>
