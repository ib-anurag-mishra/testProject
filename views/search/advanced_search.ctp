...
?>
	<div class="fullWidth" id="resultsSummary">
		<div class="search_result_text"> <h3>Results for your search "<?php echo $keyword; ?>" </h3> </div>
	<?php
		if( ( $type == 'all' ) ) {
					...
					<tbody>
						...
						<tr <?php echo $class; ?> style="margin-left:0px;">
							...
							<td width="170" valign="top" style="padding-left: 10px;">
								<p>
									<span title="<?php echo str_replace( '"', '', $this->getTextEncode( $psong->Composer ) );?>"><?php echo truncate_text( str_replace( '"', '', $psong->Composer ), 30, $this ); ?></span>
								</p>
							</td>
							<td width="182" valign="top" style="padding-left: 10px;">
								<p>
									<span title="<?php echo str_replace( '"', '', $this->getTextEncode( $psong->Title ) );?>"><a href="/artists/view/<?php echo str_replace( '/', '@', base64_encode( $psong->ArtistText ) );?>/<?php echo $psong->ReferenceID;	?>/<?php echo base64_encode( $psong->provider_type );?>"><?php echo str_replace( '"', '', truncate_text( $psong->Title, 30, $this ) );?></a></span>
								</p>
							</td>
							...
							<td width="203" valign="top" align="center" style="padding-left: 10px;">
								...
								if( $sales_date <= date( 'Y-m-d' ) ) {
									...
									?>
										...
										?>
											<a href='/homes/my_history' title='<?php __("You have already downloaded this song. Get it from your recent downloads");?>'><?php __("Downloaded");?></a>
										<?php
										}
									} else {
