...
<section class="search-page">
    ...
    <!--
        <div class="search-results-text"><span><?php echo ((empty($totalAlbums)) ? '0' : $totalAlbums) ?></span> Albums,<span><?php echo ((empty($totalArtists)) ? '0' : $totalArtists) ?></span> Artists, <span><?php echo ((empty($totalComposers)) ? '0' : $totalComposers) ?></span> Composers, <span><?php echo ((empty($videos)) ? '0' : count($videos)) ?></span> Videos, <span><?php echo ((empty($totalGenres)) ? '0' : $totalGenres) ?></span> Genres, <span><?php echo ((empty($totalSongs)) ? '0' : $totalSongs) ?></span> Songs</div> -->
                ...
                <div class="search-results-list">
                    ...
                    if (!empty($genres)) {
                        ...
                        foreach ($genres as $genre) {
                            ...
                            ?>
                                <li><a href="<?php echo "/genres/album?q=$tilte&type=genreAlbum"; ?>" title="<?php echo $this->getTextEncode($genre_name); ?>"><?php echo $this->getTextEncode($genre_name_text); ?> (<?php echo $count; ?>)</a></li>
                            <?php
                            $i++;
                        }
                        ?>
                ...
                if (!empty($composers)) {
                    ...
                    foreach ($composers as $composer) {
                        ...
                        if ( "" !=  $this->getTextEncode($composer_name) ) {
                            ?>
                                    <li><a href="/artists/composer/<?= urlencode('"'.$composer->Composer.'"'); ?>/1" title="<?php echo $this->getTextEncode($composer_name); ?>"><?php echo $this->getTextEncode($composer_name); ?> (<?php echo $count; ?>)</a></li>
                                    <?php
                                }
                                $i++;
                            }
                    ...
                    <ul>
                            ...
                            foreach ($composers as $composer) {
                                ...
                                if (!empty($composer_name)) {
                                    ?>
                                <li>
                                    <a href="/artists/composer/<?= urlencode('"'.$composer->Composer.'"'); ?>/1" title="<?php echo $this->getTextEncode($composer->Composer) ?>"><?php echo str_replace('"', '', $this->getTextEncode($composer_name)); ?></a><span>(<?php echo $composer->numFound; ?>)</span>
                                </li>
                                        <?php
                                    }
                                }
