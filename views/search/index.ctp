                                            ...
                                            <form method="Post" id="form<?php echo $psong->ProdID; ?>" action="/videos/download">
                                                ...
                                                <span class="beforeClick" id="download_video_<?php echo $psong->ProdID; ?>">
                                                    <![if !IE]>
                                                     ...
                                                     <![endif]>
                                                     <!--[if IE]>
                                                            <a title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick='wishlistVideoDownloadIE("<?php echo $psong->ProdID; ?>", "0" , "<?php echo $psong->provider_type; ?>");' href="<?php echo trim($finalVideoUrl);?>"><?php __('Download Now');?></a>
                                                     <![endif]-->
                                                </span>
