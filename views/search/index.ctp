                    ...
                    if (!empty($genres)) {
                        ...
                        foreach ($genres as $genre) {
                           ...
                           // $genre_name_text = truncate_text($genre_name, 30, $this);
                            ...
                            ?>
                                <li><a href="<?php echo "/genres/album?q=$keyword&type=album&filter=$tilte"; ?>" title="<?php echo $this->getTextEncode($genre_name); ?>"><?php echo $this->getTextEncode($genre_name_text); ?> (<?php echo $count; ?>)</a></li>
                            <?php
                            $i++;
                        }
                        ?>
            ...
            <div class="search-results-list">
                ...
                if (!empty($composers)) {
                    ...
                    <ul>
                            ...
                            foreach ($composers as $composer) {
                                $tilte = urlencode($composer->Composer);
                                $composer_name = truncate_text($this->getTextEncode($composer->Composer), 100, $this);
