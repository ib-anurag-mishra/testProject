...
<section class="<?php echo $search_category; ?>">
    ...
    <div class="search-results-text"><span><?php echo ((empty($albumData)) ? '0' : $totalAlbums) ?></span> Albums,<span><?php echo ((empty($artists)) ? '0' : $totalArtists) ?></span> Artists, <span><?php echo (($totalComposers) ? '0' : $totalComposers) ?></span> Composers, <span><?php echo ((empty($videos)) ? '0' : count($videos)) ?></span> Videos, <span><?php echo (($totalGenres) ? '0' : $totalGenres) ?></span> Genres, <span><?php echo ((empty($songs)) ? '0' : count($songs)) ?></span> Songs</div>
