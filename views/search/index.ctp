                ...
                <div class="search-results-list">
                    ...
                    if (!empty($genres)) {
                        ...
                        foreach ($genres as $genre) {
                            ...
                            ?>
                                <li><a href="<?php echo "/genres/album?q=$tilte&type=album"; ?>" title="<?php echo $this->getTextEncode($genre_name); ?>"><?php echo $this->getTextEncode($genre_name_text); ?> (<?php echo $count; ?>)</a></li>
                            <?php
                            $i++;
                        }
                        ?>
