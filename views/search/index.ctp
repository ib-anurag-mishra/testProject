...
<section class="<?php echo $search_category; ?>">
    ...
    <div class="search-results-text"><span><?php echo ((empty($albumData)) ? '0' : $totalAlbums) ?></span> Albums,<span><?php echo ((empty($artists)) ? '0' : $totalArtists) ?></span> Artists, <span><?php echo ((empty($composers)) ? '0' : $totalComposers) ?></span> Composers, <span><?php echo ((empty($videos)) ? '0' : $totalVideos) ?></span> Videos, <span><?php echo ((empty($genres)) ? '0' : $totalgenres) ?></span> Genres, <span><?php echo ((empty($songs)) ? '0' : $totalSongs) ?></span> Songs</div>
