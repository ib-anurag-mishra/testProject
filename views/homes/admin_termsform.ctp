<?php
/*
	 File Name : admin_termsform.ctp
	 File Description : View page for admin terms form
...
function languagechange(){
	var formId = document.getElementById('HomeAdminTermsformForm');
	var path = webroot+'admin/homes/termsform';
