                ...
                foreach ($new_releases_albums as $key => $value) {
                    ...
                    <li>
                        <div class="album-container">
                            ...
                            <?php
                            echo $html->link($html->image($value['albumImage'], array("height" => "250", "width" => "250")), array('controller' => 'artists', 'action' => 'view', base64_encode($value['Song']['ArtistText']), $value['Song']['ReferenceID'], base64_encode($value['Song']['provider_type'])), array('onclick' => "ga('send', 'event', 'New Release Albums', 'Artwork Click', '$count-$this->getTextEncode($value['Albums']['AlbumTitle'])')", 'class' => 'first', 'escape' => false))
                            ?>
