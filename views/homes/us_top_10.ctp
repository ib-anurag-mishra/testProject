            ...
            <ul style="width:1650px;">
				...
				?>
                        <li>
                            <div class="song-container">
								...
								?>
									...
									<?php  	else:
                                        	...
                                        	echo $this->Html->link( 'Limit Met', 'javascript:void(0)', array( 'class' => 'top-100-download-now-button download-limit-met' ) );
                                        endif;
                                    else:
                                    	$salesDate = '';
                            ...
                            <div class="artist-name">
                                <?php echo $this->Html->link( $this->Home->trimString( $value['Song']['Artist'], 20 ), array( 'controller' => 'artists', 'action' => 'album', str_replace( '/', '@', base64_encode( $value['Song']['ArtistText'] ) ), base64_encode( $value['Genre']['Genre'] ) ), array( 'title' => $this->getValidText( $this->getTextEncode( $value['Song']['Artist'] ) ), 'escape' => false ) );?>
                            </div>
                        </li>
                        <?php
                       	$count++;
