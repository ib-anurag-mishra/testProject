                                                ...
                                                <span class="mylib-top-10-video-download-now-button">
                                                    <form method="Post" id="form<?php echo $value["Video"]["ProdID"]; ?>" action="/videos/download" class="suggest_text1">
                                                        ...
                                                        <span class="beforeClick" id="download_video_<?php echo $value["Video"]["ProdID"]; ?>">
                                                            ...
                                                            <![endif]>
                                                            <!--[if IE]>
                                                            <a class="no-ajaxy top-10-download-now-button" href="javascript:void(0);" title="<?php __('IMPORTANT:  Please note that once you press Download Now you have used up one of your downloads, regardless of whether you then press Cancel or not.'); ?>" onclick="ga('send', 'event', 'Country Top Videos', 'Video Download', '<?php echo $trackingVideoTitle; ?>''); wishlistVideoDownloadIEToken('<?php echo $value['Video']['ProdID']; ?>', '0',  '<?php echo $value['Video']['provider_type']; ?>', '<?php echo $value['Video']['CdnPath']; ?>', '<?php echo $value['Video']['FullLength_SaveAsName']; ?>');"><?php __('Download Now'); ?></a>
                                                            <![endif]-->
                                                        </span>
