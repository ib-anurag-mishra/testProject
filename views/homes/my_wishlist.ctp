							...
							<p>
								<span class="beforeClick" id="wishlist_song_<?php echo $wishlistResults[$i]['wishlists']['ProdID']; ?>">
                                                                    <?php if($wishlistResults[$i]['Country']['SalesDate'] <= date('Y-m-d')) {?>
                                                                                        ...
                                                                                        <![endif]>
                                                                                        <!--[if IE]>
                                                                                        <a title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick='return wishlistDownloadIE("<?php echo $wishlistResults[$i]['wishlists']['ProdID']; ?>", "<?php echo $wishlistResults[$i]['wishlists']['id']; ?>" , "<?php echo $wishlistResults[$i]['wishlists']["provider_type"]; ?>");' href='<?php echo $finalSongUrl; ?>'><?php __('Download');?></a>
                                                                                        <![endif]-->	
                                                                    <?php } else { ?>
                                                                                <![if !IE]>
                                                                                <?php __('Coming Soon'); ?>
                        ...
                        <?php
                            ...
                            <span class="beforeClick" id="download_video_<?php echo $wishlistResultsVideo['WishlistVideo']['ProdID']; ?>">
                                <?php if($wishlistResultsVideo['Country']['SalesDate'] <= date('Y-m-d')) { ?>
                                                    ...
                                                    <![endif]>
                                                    <!--[if IE]>
                                                            <a title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick='return wishlistVideoDownloadIE("<?php echo $wishlistResultsVideo['WishlistVideo']['ProdID']; ?>","<?php echo $wishlistResultsVideo['WishlistVideo']['id']; ?>","<?php echo $wishlistResultsVideo['WishlistVideo']['provider_type']; ?>");' href='<?php echo $finalVideoUrl; ?>'><?php __('Download');?></a>
                                                    <![endif]-->
                                <?php } else { ?>
                                                <![if !IE]>
                                                <?php __('Coming Soon'); ?>
