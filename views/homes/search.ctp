					...
					{					
						if($libraryDownload == '1' && $patronDownload == '1')
                                                {	
                                                        ...
                                                        $finalSongUrl = "http://music.freegalmusic.com".$songUrl;
                                                        $finalSongUrlArr = str_split($finalSongUrl, ceil(strlen($finalSongUrl)/3));?>
                                                        <p><a href='#' onclick='Javascript: userDownload("<?php echo $searchResult["Physicalproduct"]["ProdID"]; ?>","<?php echo urlencode($finalSongUrlArr[0]);?>", "<?php echo urlencode($finalSongUrlArr[1]);?>", "<?php echo urlencode($finalSongUrlArr[2]);?>");'>Download Now</a><span id="download_loader_<?php echo $searchResult["Physicalproduct"]["ProdID"]; ?>" style="display:none;"><?php echo $html->image('ajax-loader_black.gif'); ?></span></p>
                                <?php		}											
                                                else{
