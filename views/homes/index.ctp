...
<section class="featured-artists" id="featured-artists-section">
				...
				<div class="featured-artist-ctas">
					...
					if ($this->Session->read("patron"))
					{
						if ($this->Session->read('library_type') == 2 && !empty($v['albumSongs']))
						{
							...
							echo $this->Queue->getfeaturedStreamLabel($this->getTextEncode($v['Featuredartist']['artist_name']),$v['Featuredartist']['provider_type'],$v['Featuredartist']['flag']);
						}
					}
					?>
	...
	<span id="artist_loader" style="display: none;"> <img
