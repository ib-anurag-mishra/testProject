                                                ...
                                                <tr onmouseover="this.className = 'hlt';" onmouseout="this.className = '';"> 
                                                       <td>
                                                               <p class='suggest_text'><a href='#'><?php echo $randomSongs['Home']['Title'] ?></a><br />
                                                                       by <a href='artist.php?artist=<?php echo $randomSongs['Home']['Artist'] ?>'><?php echo $randomSongs['Home']['Artist']?></a><a href='#'><img src='img/button.png'></a>
                                                               </p>
                                                       </td>                
                                                </tr>
                                         <?php endforeach; ?>    
			...
			<div id="artist_container">
				...
				<?php
				        ...
				        {
						?><a href="artist?artist=<?php echo $featuredArtist['Featuredartist']['artist_name']?> "><img src="<?php echo $featuredArtist['Featuredartist']['artist_image']?>" border="0"></a>
				<?php		
					}
				?>
				</div>
							...
							<table cellspacing="0" cellpadding="0">                                                        
							        ...
							        <tr onmouseover="this.className = 'hlt';" onmouseout="this.className = '';"> 
                                                                        <td class='artist_line'>
                                                                                <p><a href='artist.php?artist=<?php echo $allArtists['Physicalproduct']['ArtistText'] ?>'><?php echo $allArtists['Physicalproduct']['ArtistText'] ?></a></p>
                                                                        </td>
                                                                </tr>
                                                         <?php endforeach; ?>       
							</table>
