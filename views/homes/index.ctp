...
//                                                }
                                                echo $this->Queue->getNationalsongsStreamNowLabel($nationalTopDownload[$i]['File']['CdnPath'],$nationalTopDownload[$i]['File']['SourceURL'], $song_title, $nationalTopDownload[$i]['Song']['ArtistText'], $nationalTopDownload[$i]['Song']['FullLength_Duration'], $nationalTopDownload[$i]['Song']['ProdID'], $nationalTopDownload[$i]['Song']['provider_type']);
