        ...
        <nav class="top-100-nav">
            <ul>
                ...
                <li>
                    ...
                    <a href="#top-100-songs" id="songsIDVal" class="active tabs" data-category-type="songs" onclick="showHideGrid('songs')">Songs</a>


                </li>
                <li>

                    <a href="#top-100-videos" id="videosIDVal" class="tabs" data-category-type="videos" onclick="showHideGrid('videos')">Videos</a>
