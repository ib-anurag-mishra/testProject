...
<?php
    ...
    if($this->Session->read('patron')) {
        ...
        ?>
            <a class="top-100-download-now-button" title='<?php __("Coming Soon");?> ( <?php if(isset($nationalTopDownload[$i]['Country']['SalesDate'])){ echo date("F d Y", strtotime($nationalTopDownload[$i]['Country']['SalesDate']));} ?> )' href="javascript:void(0);"><?php __("Coming Soon");?></a>
        <?php
        }
}else{
