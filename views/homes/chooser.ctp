            ...
            <div class="sidebox">
                    <div class="holder">
                            ...
                            <?php foreach($libraries as $library_var) { $library_name_var   =   $library_var['Library']['library_name'] ?>
                                <tr>
                                    <td><a alt="<?php echo $library_name_va; ?>r" href="<?php echo 'http://'.$library_var['Library']['library_subdomain'];?>.freegaldev.com/users/redirection_manager"><?php echo (strlen($library_name_var)>45)?substr(strtoupper($library_name_var),0,45)."...":$library_name_var; ?></a></td>
                                </tr>
                            <?php } ?>
                            </table>
                            </div>
