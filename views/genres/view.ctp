        ...
        <div class="genre-shadow-container">
            ...
            <div class="genre-list">
                ...
                <ul>
                    ...
                    <li><a class="genre_list_item_all <?php
                        if ($genre == 'All')
                        {
                            ?>selected <?php } ?>" href="#" data-genre="All Artists" id="genre_list_item_0" onclick="load_artist('/genres/ajax_view/<?php echo base64_encode('All'); ?>/All', '0', '<?php echo addslashes('All'); ?>')"><?php echo __('All Artists'); ?></a></li>					  
