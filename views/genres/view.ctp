			...
			<div class="artist-list-shadow-container">
				...
				<div class="artist-list" id="artistscroll">					
					<ul id="artistlistrecord">						                                            
                                    ...
                                    <span id="artist_loader" style="padding-left:115px;padding-buttom:25px;display:none;" ><img src="<? echo $this->webroot; ?>app/webroot/img/aritst-ajax-loader.gif" border="0"/></span>
				</div>
			</div>
                   </div>                  
