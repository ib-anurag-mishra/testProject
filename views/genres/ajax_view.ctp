		...
		<div class="alphabetical-shadow-container">
				...
				<div class="alphabetical-filter">
                                                                        <ul>
                                    <li><a href="javascript:void(0);" data-letter="All<?=$isCallFromGenre;?>" <?php if($isCallFromGenre == 1){?>class="selected"<?php } ?> onclick="load_artist('/genres/ajax_view/<?php echo base64_encode($genre); ?>' ,'' , '')">ALL</a></li>                                            
