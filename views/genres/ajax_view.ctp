   ...
   $("#artistscroll").scroll(function(){  
		...
		<!-- <div class="alphabetical-shadow-container">
				...
				<div class="alpha-artist-list-column">
                                    ...
                                    <?php  if(!in_array('spl',$artistsNoAlpha)){ ?><li><a  href="javascript:void(0);" data-letter="#"   <?php if($selectedAlpha =="spl") {?>class="selected active" <?php } ?>   onclick="load_artist('/genres/ajax_view/<?php echo base64_encode($genre); ?>/spl' ,'' , '')" >#</a></li><?php } ?> 
