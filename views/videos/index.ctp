                                ...
                                <div class="video-thumbnail-container">
                                    ...
                                    if ($this->Session->read('patron'))
                                    {
                                        ...
                                        if ($libraryDownload == '1' && $patronDownload == '1')
                                        {
                                            ...
                                            {
                                                ?>
                                                <a class="featured-video-download-now-button " <?php /*href='/homes/my_history'*/ ?> onclick="$.Ajaxify.loadURL('//homes/my_history');"><label class="dload" style="width:120px;cursor:pointer;" title='<?php __("You have already downloaded this song. Get it from your recent downloads"); ?>'><?php __('Downloaded'); ?></label></a>
                                                <?php
                                            }
                                        }
                                        else
