                            ...
                            <div class="video-thumbnail-container">
                                ...
                                <form method="Post" id="form<?php echo $featureVideo["FeaturedVideo"]["ProdID"]; ?>" action="/videos/download">
                                    ...
                                    <span id="song_<?php echo $featureVideo["FeaturedVideo"]["ProdID"]; ?>" class="beforeClick">
                                            <a class="featured-video-download-now-button" href='#' title="<?php __("IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press `Cancel` or not.");?>" onclick='userDownloadAll(<?php echo $featureVideo["FeaturedVideo"]["ProdID"]; ?>);'><?php __('Download Now');?></a>
                                    </span>
                                <span id="downloading_<?php echo $featureVideo["FeaturedVideo"]["ProdID"]; ?>" class="afterClick" style="display:none;">Please Wait...</span>
                                <span id="download_loader_<?php echo $featureVideo["FeaturedVideo"]["ProdID"]; ?>" style="display:none;float:right;">
                                </form>
