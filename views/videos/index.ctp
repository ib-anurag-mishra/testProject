                                            ...
                                            if ($topDownload['Video']['status'] != 'avail')
                                            {
                                                ...
                                                <form method="post" id="form<?php echo $topDownload["Video"]["ProdID"]; ?>" action="/videos/download">
                                                    ...
                                                    <span class="beforeClick" id="download_video_<?php echo $topDownload["Video"]["ProdID"]; ?>">
                                                        ...
                                                        <![endif]>
                                                        <!--[if IE]>
                                                                <label class="top-10-download-now-button"><a class="no-ajaxy" title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick="wishlistVideoDownloadIEToken('<?php echo $topDownload['FeaturedVideo']['ProdID']; ?>','0','<?php echo $topDownload['Video']['provider_type']; ?>', '<?php echo $topDownload['File']['CdnPath']; ?>', '<?php echo $topDownload['Video_file']['SaveAsName']; ?>');" href="javascript:void(0);"><?php __('Download Now'); ?></a></label>
                                                        <![endif]-->
                                                    </span>
