                                                ...
                                                <div class="download-now-button ">
                                                    <form method="Post" id="form<?= $value["Video"]["ProdID"]; ?>" action="/videos/download" class="suggest_text1">
                                                        ...
                                                        <span class="beforeClick" id="download_video_<?= $value["Video"]["ProdID"]; ?>">
                                                            <![if !IE]>
                                                            <a class="no-ajaxy top-10-download-now-button" href="javascript:void(0);" title="<?= __('IMPORTANT:  Please note that once you press Download Now you have used up one of your downloads, regardless of whether you then press Cancel or not.'); ?>" onclick='return wishlistVideoDownloadOthersToken("<?= $value['Video']['ProdID']; ?>", "0", "<?= $value['Video']['CdnPath']; ?>", "<?= $value['Video']['FullLength_SaveAsName']; ?>",  "<?= $value['Video']['provider_type']; ?>");'><label class="top-10-download-now-button"><?= __('Download Now'); ?></label></a>
                                                            <![endif]>
                                                            <!--[if IE]>
                                                                    <label class="top-10-download-now-button"><a class="no-ajaxy" title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick="wishlistVideoDownloadIEToken('<?= $value['Video']['ProdID']; ?>','0','<?= $value['Video']['provider_type']; ?>', '<?= $value['Video']['CdnPath']; ?>', '<?= $value['Video']['FullLength_SaveAsName']; ?>');" href="javascript:void(0);"><?= __('Download Now'); ?></a></label>
                                                            <![endif]-->
                                                        </span>
