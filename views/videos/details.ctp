                            ...
                            <div class="download-now-button ">
                                <form method="Post" id="form<?= $videosData[0]["Video"]["ProdID"]; ?>" action="/videos/download" class="suggest_text1">
                                    ...
                                    <span class="beforeClick" id="download_video_<?= $videosData[0]["Video"]["ProdID"]; ?>">
                                        <![if !IE]>
                                        <a class="top-10-download-now-button no-ajaxy" href="javascript:void(0);" title="<?= __('IMPORTANT:  Please note that once you press Download Now you have used up one of your downloads, regardless of whether you then press Cancel or not.'); ?>" onclick='return wishlistVideoDownloadOthers("<?= $videosData[0]['Video']['ProdID']; ?>", "0", "<?= urlencode($finalVideoUrlArr[0]); ?>", "<?= urlencode($finalVideoUrlArr[1]); ?>", "<?= urlencode($finalVideoUrlArr[2]); ?>", "<?= $videosData[0]['Video']['provider_type']; ?>");'><label class="top-10-download-now-button"><?= __('Download Now'); ?></label></a>
                                        <![endif]>
                                        <!--[if IE]>
                                                <label class="top-10-download-now-button"><a class="no-ajaxy" title="IMPORTANT: Please note that once you press `Download Now` you have used up one of your downloads, regardless of whether you then press 'Cancel' or not." onclick="wishlistVideoDownloadIE('<?= $videosData[0]['Video']['ProdID']; ?>','0','<?= $videosData[0]['Video']['provider_type']; ?>');" href="<?= trim($finalVideoUrl); ?>"><?= __('Download Now'); ?></a></label>
                                        <![endif]-->
                                    </span>
