                                ...
                                if(strtotime($VideosData[0]['Country']['SalesDate']) < time()){
                                    if($libraryDownload == '1' && $patronDownload == '1'){
                                        ...
                                        if($VideosData[0]['Video']['status'] != 'avail') {?>
                                            ...
                                            <a  title='<?php __($this->getValidText('IMPORTANT:  Please note that once you press "Download Now" you have used up one of your downloads, regardless of whether you then press "Cancel" or not.'));?>' href='javascript:void(0);' onclick='videoDownloadAll("<?php echo $VideosData[0]["Video"]["ProdID"]; ?>");'><label class="dload" style="width:120px;cursor:pointer;" ><?php __('Download Now');?></label></a>
                                            </span>
                                    ...
                                    <?php
                                            ...
                                            <a class="download-now-button " href='/homes/my_history'><label class="dload" style="width:120px;cursor:pointer;" title='<?php __($this->getValidText("You have already downloaded this song. Get it from your recent downloads"));?>'><?php __('Downloaded'); ?></label></a>
                                        <?php
                                        }
                                    }
                                    ?>
                                                  ...
                                                  if(strtotime($value['Country']['SalesDate']) < time()){
                                                            ...
                                                            if($libraryDownload == '1' && $patronDownload == '1') 
                                                            {
                                                                ...
                                                                if($value['Video']['status'] != 'avail') {?>                                               
                                                                    ...
                                                                    <a  title='<?php __($this->getValidText('IMPORTANT:  Please note that once you press "Download Now" you have used up one of your downloads, regardless of whether you then press "Cancel" or not.'));?>' href='javascript:void(0);' onclick='videoDownloadAll("<?php echo $value["Video"]["ProdID"]; ?>");'><label class="dload" style="width:120px;cursor:pointer;" ><?php __('Download Now');?></label></a>
                                                                    </span>
