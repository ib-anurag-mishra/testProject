<?php
    ...
    foreach($data as $k=>$row) {
        ...
        $tcpdf->Cell($w[4], 12, "Falak Se Sitara Falak Se Sitara Falak Se Sitara Falak Se\nSitara Falak Se Sitara Falak Se Sitara", 'LR', 0, 'L', $fill, '', 3);
        //$tcpdf->MultiCell($w[4], 12, $row[4], 'LR', 'L',  0, 1, '', '', false);
