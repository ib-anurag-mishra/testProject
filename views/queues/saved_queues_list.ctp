                                    ...
                                    <?php $i = 0;
                                          foreach($queueData as $key => $value){
                                                ...
                                                <div class="playlist-info-container">
                                                    ...
                                                    <div class="playlist-title"><a href="/queuelistdetails/queue_details/<?php echo $value['QueueList']['queue_id'];?>/0/<?php echo base64_encode($value['QueueList']['queue_name']); ?>"><?php echo $value['QueueList']['queue_name']; ?></a></div>
