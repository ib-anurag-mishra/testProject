								...
								<li><a href="#">Playlist 10</a></li>
										...
										?>
                                                                                                    ...
                                                                                                    <form method="Post" id="form<?php echo $albumSong["Song"]["ProdID"]; ?>" action="/homes/userDownload">
                                                                                                            ...
                                                                                                            <span class="beforeClick add-to-wishlist" style="display:none;" id="song_<?php echo $albumSong["Song"]["ProdID"]; ?>">
                                                                                                            ...
                                                                                                            <span class="afterClick add-to-wishlist" id="downloading_<?php echo $albumSong["Song"]["ProdID"]; ?>" style="float:left"><?php __("Please Wait..");?></span>
