...
<section class="tracklist-container">
	...
	<div class="tracklist">
		...
		<div class="song" style="width: 200px;">
			<?php
		...
		<div class="artist">
			<a
				...
				href="/artists/album/<?php echo base64_encode($albumSong['Song']['Artist']); ?>"><?php
		...
		{
			?>
		<a class="genre-download-now-button" href='/users/redirection_manager'>
			<?php __("Login"); ?>
		</a>
