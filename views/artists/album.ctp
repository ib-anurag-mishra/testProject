                  ...
                  $value['Video']['status'] = 'not';
                    ...
                    if($value['Video']['status'] != 'avail' ) {
                            ...
                            <span class="beforeClick" id="download_video_<?php echo $value['Video']['ProdID']; ?>">
                                <![if !IE]>
                                    <a title="<?php __('IMPORTANT:  Please note that once you press Download Now you have used up one of your downloads, regardless of whether you then press Cancel or not.');?>" href="#" onclick='return wishlistVideoDownloadOthers("<?php echo $value['Video']['ProdID']; ?>","0", "<?php echo urlencode($finalVideoUrlArr[0]);?>", "<?php echo urlencode($finalVideoUrlArr[1]);?>", "<?php echo urlencode($finalVideoUrlArr[2]);?>", "<?php echo $value['Video']['provider_type']; ?>");'><label class="top-100-download-now-button"><?php __('Download Now');?></label></a>
                                <![endif]>
                                <!--[if IE]>
