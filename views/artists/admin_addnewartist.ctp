...
<table cellspacing="10" cellpadding="0" border="0" width="100%">
		...
		<td align="left">
			<?php
				echo $this->Form->input('territory', array('options' => array(
					'' => 'Choose Territory',
					'US' => 'US',
					'CA' => 'CA'),'label' => false, 'div' => false, 'class' => 'select_fields','default' => $getData['Newartist']['territory'])
				);
			?>
		</td>
	</tr>
	<tr>
		...
		<td align="left"><div id="getArtist"><?php echo $form->select('artist_name', $getArtistData, $getData['Newartist']['artist_name'], array('label' => false, 'div' => false, 'class' => 'select_fields')); ?></div></td>
	</tr>
	<tr>
