...
<table cellpadding="3" cellspacing="3" >
    <tr>
		...
		<tr>
			...
			<td><?php echo $html->link('Edit', array('controller'=>'artists','action'=>'createartist','id'=>$artist['Artist']['id']));?></td>
                        <td ><?php echo $this->Form->input("Info. ", array('type'=>'checkbox','id'=>$artist['Artist']['id'], 'value' => $artist['Artist']['id'], 'hiddenField' => false)); ?></td>
		</tr>
		<?php
		}
		?>
	...
	<?php echo $this->Form->hidden('selectedOpt'); ?>
                     ...
                     <tr>
                         <td><?php echo $this->Form->button('Remove Selected', array('name' => 'remove_selected','label'=>'Remove Selected','onclick' => 'return m_delete(1)')); ?></td>
                         <td><?php echo $this->Form->button('Remove All', array('name' => 'remove_all','label'=>'Remove All','onclick' => 'return m_delete(2)')); ?></td>
                     </tr>
