...
<legend>Artist Listing</legend>
	<table id="list">
		...
		<tr>
			...
			<td><a href="<?php echo $cdnPath.$artist['Artist']['artist_image'];?>" rel="image" onclick="javascript: show_uploaded_images('<?php echo $cdnPath.$artist['Artist']['artist_image'];?>')"><?php echo $artistImage;?></a></td>                
