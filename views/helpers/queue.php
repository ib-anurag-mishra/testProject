...
$str = <<<EOD
       <a onclick="loadSong('$streamUrl','$this->getValidText($songTitle)','$this->getValidText($artistText)',$songLength,$songProdId,'$providerType');"  class="album-preview" href="javascript:void(0);" >Stream Now</a>        
EOD;
        return $str;
