...
class DataencodeHelper extends AppHelper {

	public function getTextEncode($text) {
	...
	public function getAdminTextEncode($text) {                  // Function used only in Admin

		//return $this->decode_utf8($text);
		return $this->decode_utf8($this->getTextEncode($text));
	}

	public function getValidText($text) {                  // Replace Single, Double Quotes, & with HTML entities in Text
